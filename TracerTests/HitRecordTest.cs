...
public class HitRecordTest
{
    ...
    public void TestConstructor()
    {
        ...
        HitRecord record = new HitRecord(point, TODO,  normal, surfacePoint, ray, 2 );
    ...
    public void TestAreHitRecordsClose()
    {
        ...
        HitRecord record1 = new HitRecord(point1, TODO,  normal1, surfacePoint1, ray1, 2 );
        ...
        HitRecord record2 = new HitRecord(point2, TODO,  normal2, surfacePoint2, ray2, 2.00004f );
