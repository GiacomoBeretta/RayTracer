...
public class WorldTest
{
    ...
    public void TestRayIntersection()
    {
        ...
        var i1 = world.RayIntersection(new Ray(new Point(0f, 0f, 0f), new Vector(1f, 0f, 0f)));
        var i2 = world.RayIntersection(new Ray(new Point(10f, 0f, 0f), new Vector(-1f, 0f, 0f)));
